 ...
 */
public class ValueRemove implements Command {
    ...
    public final String[] getAliases() {
        return new String[] { "valuerm", "removevalue", "rmvalue" };
    }
    ...
    public final String usage() {
        return "valueremove <property> <value> [<type>]";
    }
    ...
    public final String help() {
        return "remove a value from an existing multi value property, default type is String";
    }
    ...
    public final boolean execute(final String[] args) {
        ...
        try {
            ...
            if (!found) {
                System.out.println("Property value not found: " + propValue);
                return false;
            }
